...
sys.path.insert(0, os.path.abspath("../mip_dmp"))
...
project = "mip_dmp: Assistant for mapping datasets to the common schema of a federation of the Medical Informatics Platform"
copyright = "2023, The MIP team, University Hospital of Lausanne (CHUV), Switzerland & Contributors".format(
    time.strftime("%Y")
)
...
html_title = "mip_dmp: Assistant for mapping datasets to the common schema of a federation of the Medical Informatics Platform"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "mip_dmp"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "../mip_dmp/qt5/assets/mip_dmp_icon.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "../mip_dmp/qt5/assets/mip_dmp_icon.png"
...
latex_documents = [
    (
        "index",
        "MIPDMP.tex",
        "MIP Dataset Mapper Documentation",
        "The MIP team and Contributors",
        "manual",
    ),
]
